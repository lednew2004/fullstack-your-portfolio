  ...
  return (
    <div className="w-full py-16 px-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl mb-10">
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Escolha seu plano</h1>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* GRATUITO */}
        <div className="p-6 border border-neutral-800 rounded-md flex flex-col justify-between">
          <div>
            <h2 className="text-xl font-bold mb-2">Grátis</h2>
            <p className="text-neutral-400 mb-4">Para começar</p>

            <p className="text-3xl font-bold mb-6 text-neutral-200">R$0</p>
          ...
          <Link
            href="/register"
            className="mt-6 bg-zinc-900 text-center hover:bg-neutral-700 text-white py-2 rounded"
          >
            Começar grátis
          </Link>
        </div>
        ...
        {/* MENSAL */}
        <div className="p-6 border border-lime-400 rounded-md flex flex-col justify-between">
          <div>
          ...
          <button
            ...
            className="mt-6 bg-lime-400 hover:bg-lime-300 text-black py-2 rounded"
          >
            Assinar
          </button>
        </div>
        ...
        {/* ANUAL */}
        <div className="p-6 border border-lime-500 rounded-md flex flex-col justify-between">
          <div>
